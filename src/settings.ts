...
export class GitNotesSettings {
  ...
  constructor() {
    ...
    this.logger = LoggerService.getInstance(
      this._config.get("logLevel", LogLevel.info)
    );
  ...
  public get enableNotificationsWhenNotesFound(): boolean {
    this.logger.debug(
      "GitNotesSettings get enableNotificationsWhenNotesFound called"
    );
  ...
  public get confirmPushAndFetchCommands(): boolean {
    this.logger.debug(
      "GitNotesSettings get confirmPushAndFetchCommands called"
    );
  ...
  public get isDarkThemeEnabled(): boolean {
    ...
    this.logger.debug(
      `GitNotesSettings isDarkThemeEnabled ${theme.includes("Dark")}`
    );
